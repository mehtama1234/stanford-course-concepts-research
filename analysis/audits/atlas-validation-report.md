...
```text
validated 28 concepts, 6 themes, 15 subthemes, 131 evidence records, 10 primitives, 9 method families; 3 manually deepened concepts, 3 manually deepened evidence records
...
This is now a local, reader-facing first-principles lab backed by generated research artifacts and stronger quality gates than the first structural pass. The editorial pass has started with manual deepening for `attention`, `q_learning`, and `diffusion`, plus their primary evidence spans.
